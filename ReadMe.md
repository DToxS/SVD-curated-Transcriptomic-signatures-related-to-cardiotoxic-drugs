...
Both downloads contain one folder called 'LINCS_DToxS_SVD'. Simply merge these folders and copy it to your hard drive (e.g. to 'D:' generating 'D:/LINCs_DToxS_SVD/').<br>
