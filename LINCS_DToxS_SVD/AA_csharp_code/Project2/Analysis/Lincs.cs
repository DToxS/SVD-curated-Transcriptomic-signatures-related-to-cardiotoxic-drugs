...
namespace Lincs
{
    ...
    class Lincs_svd_manuscript_class
    {
        ...
        public static void Do_enrichment_on_degs_from_svd_focussing_on_outlier_responses(string dataset, string decomposition_method, string processing_method, int topDEGs, Deg_score_of_interest_enum deg_score_of_interest, DownstreanEnrichment_score_of_interest_enum rocScoreOfInterest, string dataType)
        {
            ...
            string[] anthracyclines = drug_legend.Get_all_drugs_of_indicated_types(Drug_type_enum.Anthracycline);
            ...
            foreach (Enrichment2018_results_class enrichment_result in enrichment_results)
            {
                ...
                if (dataType.Equals(dataType_decomposed))
                {
                    ...
                    integrationGroup_enrichment.Keep_only_lincs_drugTypes(Drug_type_enum.Kinase_inhibitor, Drug_type_enum.Monoclonal_antibody, Drug_type_enum.Anthracycline);
                    ...
                    mbco_integrationGroups_input.Set_datasetOrderNos_based_on_colors_within_integrationGroups();
                }
                #endregion
            ...
            if (dataType.Equals(dataType_decomposed))
            {
                ...
                mbco_integrationGroups_input.Write_readMe_file(Global_directory_class.Get_MBCO_desktop_application_directory(dataset));
                downstream.Options.Write_results = false;
            }
            #endregion
        ...
        public static void Add_additional_information_to_files_for_website(string dataType)
        {
            ...
            string supplTables_subdirectory = Global_directory_class.SupplData_subdirectory;
        ...
        public static void Organize_supplData()
        {
            string target_directory = Global_directory_class.Results_directory + Global_directory_class.SupplData_subdirectory;
            ...
            sourceFileName_targetFileName_dict.Add("Suppl_table_Drug_metadata.txt", "Supplementary Data 03 - Cardiotoxicity of used drugs.txt");
            ...
            sourceFileName_targetFileName_dict.Clear();
            sourceFileName_targetFileName_dict.Add("Top_600_drug-induced_DEGs_per_cell_line.txt", "Supplementary Data 04 - DEGs in each cell line.txt");
            sourceFileName_targetFileName_dict.Add("Averaged_drug-induced_DEGs_counting_top600DEG.txt", "Supplementary Data 05 - Averaged DEGs across all cell lines.txt");
            sourceFileName_targetFileName_dict.Add("Top_600_drug-induced_DEGs_per_cell_line after removal of 1st eigenarray.txt", "Supplementary Data 08 - DEGs no 1st EA in each cell line.txt");
            sourceFileName_targetFileName_dict.Add("Top_600_drug-induced_DEGs_per_cell_line after projection into drug-selective subspaces.txt", "Supplementary Data 09 - Drug-selective DEGs in each cell line.txt");
            sourceFileName_targetFileName_dict.Add("Averaged_drug-induced_DEGs after projection into drug-selective subspaces_counting_top600DEG.txt", "Supplementary Data 10 - Averaged drug-selective DEGs across all cell lines.txt");
            Copy_sourceFiles_to_targetDestination(sourceFileName_targetFileName_dict, source_directory, target_directory);

            source_directory = Global_directory_class.Results_directory + Global_directory_class.Eigenarray_subdirectory;
            sourceFileName_targetFileName_dict.Clear();
            sourceFileName_targetFileName_dict.Add("Supplemental_Table_4 - Top600genes_of_first_eigenarray.txt", "Supplementary Data 06 - Top600genes_of_first_eigenarray.txt");
            sourceFileName_targetFileName_dict.Add("Supplemental_table_5 - MBCOL2 for 1st eigenassay.txt", "Supplementary Data 07 - MBCOL2 for 1st eigenassay.txt");
            Copy_sourceFiles_to_targetDestination(sourceFileName_targetFileName_dict, source_directory, target_directory);
            ...
            sourceFileName_targetFileName_dict.Clear();
            sourceFileName_targetFileName_dict.Add("Supplemental_table_MBCOL1.txt", "Supplementary Data 11A - drug-selective DEGs - MBCOL1.txt");
            sourceFileName_targetFileName_dict.Add("Supplemental_table_MBCOL2.txt", "Supplementary Data 11B - drug-selective DEGs - MBCOL2.txt");
            sourceFileName_targetFileName_dict.Add("Supplemental_table_MBCOL3.txt", "Supplementary Data 11C - drug-selective DEGs - MBCOL3.txt");
            sourceFileName_targetFileName_dict.Add("Supplemental_table_MBCOL4.txt", "Supplementary Data 11D - drug-selective DEGs - MBCOL4.txt");
            Copy_sourceFiles_to_targetDestination(sourceFileName_targetFileName_dict, source_directory, target_directory);
            ...
            sourceFileName_targetFileName_dict.Clear();
            sourceFileName_targetFileName_dict.Add("Supplemental_table_MBCOL1.txt", "Supplementary Data 12A - complete DEGs - MBCOL1.txt");
            sourceFileName_targetFileName_dict.Add("Supplemental_table_MBCOL2.txt", "Supplementary Data 12B - complete DEGs - MBCOL2.txt");
            sourceFileName_targetFileName_dict.Add("Supplemental_table_MBCOL3.txt", "Supplementary Data 12C - complete DEGs - MBCOL3.txt");
            sourceFileName_targetFileName_dict.Add("Supplemental_table_MBCOL4.txt", "Supplementary Data 12D - complete DEGs - MBCOL4.txt");
            Copy_sourceFiles_to_targetDestination(sourceFileName_targetFileName_dict, source_directory, target_directory);
            ...
            sourceFileName_targetFileName_dict.Clear();
            sourceFileName_targetFileName_dict.Add("Supplemental_table_MBCOL1.txt", "Supplementary Data 13A - DEGs no 1st EA - MBCOL1.txt");
            sourceFileName_targetFileName_dict.Add("Supplemental_table_MBCOL2.txt", "Supplementary Data 13B - DEGs no 1st EA - MBCOL2.txt");
            sourceFileName_targetFileName_dict.Add("Supplemental_table_MBCOL3.txt", "Supplementary Data 13C - DEGs no 1st EA - MBCOL3.txt");
            sourceFileName_targetFileName_dict.Add("Supplemental_table_MBCOL4.txt", "Supplementary Data 13D - DEGs no 1st EA - MBCOL4.txt");
            Copy_sourceFiles_to_targetDestination(sourceFileName_targetFileName_dict, source_directory, target_directory);

            source_directory = Global_directory_class.Results_svd_enrichment_directory + "DEGenes_iPSCdCMs_P0_enrichment_maxP0.05_top600DEGs_in_decomposed_rocForFractional_rank/";
            sourceFileName_targetFileName_dict.Clear();
            sourceFileName_targetFileName_dict.Add("ST_Cardiotoxicity_Mbco_level1_SCP_summaries_betaF1_beta0.25_penalty0.5_plusVariantCounts_minAQ0.txt", "Supplementary Data 14A - Potential cardiotoxic MBCOL1 SCPs.txt");
            sourceFileName_targetFileName_dict.Add("ST_Cardiotoxicity_Mbco_level2_SCP_summaries_betaF1_beta0.25_penalty0.5_plusVariantCounts_minAQ0.txt", "Supplementary Data 14B - Potential cardiotoxic MBCOL2 SCPs.txt");
            sourceFileName_targetFileName_dict.Add("ST_Cardiotoxicity_Mbco_level3_SCP_summaries_betaF1_beta0.25_penalty0.5_plusVariantCounts_minAQ0.txt", "Supplementary Data 14C - Potential cardiotoxic MBCOL3 SCPs.txt");
            sourceFileName_targetFileName_dict.Add("ST_Cardiotoxicity_Mbco_level4_SCP_summaries_betaF1_beta0.25_penalty0.5_plusVariantCounts_minAQ0.txt", "Supplementary Data 14D - Potential cardiotoxic MBCOL4 SCPs.txt");
            Copy_sourceFiles_to_targetDestination(sourceFileName_targetFileName_dict, source_directory, target_directory);

            source_directory = Global_directory_class.ScRNAseq_schaniel_markerGenes_directory;
            sourceFileName_targetFileName_dict.Clear();
            sourceFileName_targetFileName_dict.Add("ScRNAseq_iPSCdCM_schaniel_markerGenes.txt", "Supplementary Data 15 - Cluster marker genes hiPSCd CMs.txt");
            Copy_sourceFiles_to_targetDestination(sourceFileName_targetFileName_dict, source_directory, target_directory);

            source_directory = Global_directory_class.ScSnRNAseq_enrichment_results_directory;
            sourceFileName_targetFileName_dict.Clear();
            sourceFileName_targetFileName_dict.Add("Tucker_2020_adult_heart_cell_type_marker_genes_ScRNAseq_iPSCdCM_schaniel_all.txt", "Supplementary Data 16A - Cluster marker genes iPSCd CMs - adult heart.txt");
            sourceFileName_targetFileName_dict.Add("Asp_2019_developing_heart_cell_type_marker_genes_ScRNAseq_iPSCdCM_schaniel_filtered.txt", "Supplementary Data 16B - Cluster marker genes iPSCd CMs - developing heart.txt");
            sourceFileName_targetFileName_dict.Add("MBCOL1_ScRNAseq_iPSCdCM_schaniel_filtered.txt", "Supplementary Data 16C - Cluster marker genes hiPSCd CMs - MBCOL1.txt");
            sourceFileName_targetFileName_dict.Add("MBCOL2_ScRNAseq_iPSCdCM_schaniel_filtered.txt", "Supplementary Data 16D - Cluster marker genes hiPSCd CMs - MBCOL2.txt");
            sourceFileName_targetFileName_dict.Add("MBCOL3_ScRNAseq_iPSCdCM_schaniel_filtered.txt", "Supplementary Data 16E - Cluster marker genes hiPSCd CMs - MBCOL3.txt");
            sourceFileName_targetFileName_dict.Add("MBCOL4_ScRNAseq_iPSCdCM_schaniel_filtered.txt", "Supplementary Data 16F - Cluster marker genes hiPSCd CMs - MBCOL4.txt");
            Copy_sourceFiles_to_targetDestination(sourceFileName_targetFileName_dict, source_directory, target_directory);

            source_directory = Global_directory_class.ScRNAseq_litvinukova_markerGenes_directory;
            sourceFileName_targetFileName_dict.Clear();
            sourceFileName_targetFileName_dict.Add("CellType_markers_Litvinukova_2020_cellsAdultHumanHeart.txt", "Supplementary Data 17 - Cluster marker genes adult heart.txt");
            Copy_sourceFiles_to_targetDestination(sourceFileName_targetFileName_dict, source_directory, target_directory);

            source_directory = Global_directory_class.ScSnRNAseq_enrichment_results_directory;
            sourceFileName_targetFileName_dict.Clear();
            sourceFileName_targetFileName_dict.Add("MBCOL1_ScRNAseq_litvinukova_adultHeart_filtered.txt", "Supplementary Data 18A - Cluster marker genes adult heart - MBCOL1.txt");
            sourceFileName_targetFileName_dict.Add("MBCOL2_ScRNAseq_litvinukova_adultHeart_filtered.txt", "Supplementary Data 18B - Cluster marker genes adult heart - MBCOL2.txt");
            sourceFileName_targetFileName_dict.Add("MBCOL3_ScRNAseq_litvinukova_adultHeart_filtered.txt", "Supplementary Data 18C - Cluster marker genes adult heart - MBCOL3.txt");
            sourceFileName_targetFileName_dict.Add("MBCOL4_ScRNAseq_litvinukova_adultHeart_filtered.txt", "Supplementary Data 18D - Cluster marker genes adult heart - MBCOL4.txt");
            Copy_sourceFiles_to_targetDestination(sourceFileName_targetFileName_dict, source_directory, target_directory);

            source_directory = Global_directory_class.ScSnRNAseq_enrichment_results_directory;
            sourceFileName_targetFileName_dict.Clear();
            sourceFileName_targetFileName_dict.Add("MBCOL1_ScRNASeq_chun_DCM_filtered.txt", "Supplementary Data 19A - juvenile DCM hiPSCdCMs scRNAseq - MBCOL1.txt");
            sourceFileName_targetFileName_dict.Add("MBCOL2_ScRNASeq_chun_DCM_filtered.txt", "Supplementary Data 19B - juvenile DCM hiPSCdCMs scRNAseq - MBCOL2.txt");
            sourceFileName_targetFileName_dict.Add("MBCOL3_ScRNASeq_chun_DCM_filtered.txt", "Supplementary Data 19C - juvenile DCM hiPSCdCMs scRNAseq - MBCOL3.txt");
            sourceFileName_targetFileName_dict.Add("MBCOL4_ScRNASeq_chun_DCM_filtered.txt", "Supplementary Data 19D - juvenile DCM hiPSCdCMs scRNAseq - MBCOL4.txt");
            Copy_sourceFiles_to_targetDestination(sourceFileName_targetFileName_dict, source_directory, target_directory);

            source_directory = Global_directory_class.ScSnRNAseq_enrichment_results_directory;
            sourceFileName_targetFileName_dict.Clear();
            sourceFileName_targetFileName_dict.Add("MBCOL1_ScRNASeq_koenig_DCM_filtered.txt", "Supplementary Data 20A - DCM heart scRNAseq - MBCOL1.txt");
            sourceFileName_targetFileName_dict.Add("MBCOL2_ScRNASeq_koenig_DCM_filtered.txt", "Supplementary Data 20B - DCM heart scRNAseq - MBCOL2.txt");
            sourceFileName_targetFileName_dict.Add("MBCOL3_ScRNASeq_koenig_DCM_filtered.txt", "Supplementary Data 20C - DCM heart scRNAseq - MBCOL3.txt");
            sourceFileName_targetFileName_dict.Add("MBCOL4_ScRNASeq_koenig_DCM_filtered.txt", "Supplementary Data 20D - DCM heart scRNAseq - MBCOL4.txt");
            Copy_sourceFiles_to_targetDestination(sourceFileName_targetFileName_dict, source_directory, target_directory);

            source_directory = Global_directory_class.ScSnRNAseq_enrichment_results_directory;
            sourceFileName_targetFileName_dict.Clear();
            sourceFileName_targetFileName_dict.Add("MBCOL1_SnRNASeq_chaffin_DCM_HCM_filtered.txt", "Supplementary Data 21A - DCM HCM heart snRNAseq - MBCOL1.txt");
            sourceFileName_targetFileName_dict.Add("MBCOL2_SnRNASeq_chaffin_DCM_HCM_filtered.txt", "Supplementary Data 21B - DCM HCM heart snRNAseq - MBCOL2.txt");
            sourceFileName_targetFileName_dict.Add("MBCOL3_SnRNASeq_chaffin_DCM_HCM_filtered.txt", "Supplementary Data 21C - DCM HCM heart snRNAseq - MBCOL3.txt");
            sourceFileName_targetFileName_dict.Add("MBCOL4_SnRNASeq_chaffin_DCM_HCM_filtered.txt", "Supplementary Data 21D - DCM HCM heart snRNAseq - MBCOL4.txt");
            Copy_sourceFiles_to_targetDestination(sourceFileName_targetFileName_dict, source_directory, target_directory);

            source_directory = Global_directory_class.Results_directory + "SVD_" + "DEGenes_iPSCdCMs_ECCoCulture" + "_supplemental_DEGs/";
            sourceFileName_targetFileName_dict.Clear();
            sourceFileName_targetFileName_dict.Add("Top_600_drug-induced_DEGs_per_cell_line.txt", "Supplementary Data 22A - DEGs EC coculture.txt");
            sourceFileName_targetFileName_dict.Add("Top_600_drug-induced_DEGs_per_cell_line after removal of 1st eigenarray.txt", "Supplementary Data 22B - DEGs EC coculture no 1st EA.txt");
            sourceFileName_targetFileName_dict.Add("Top_600_drug-induced_DEGs_per_cell_line after projection into drug-selective subspaces.txt", "Supplementary Data 22C - drug-selective DEGs EC coculture.txt");
            Copy_sourceFiles_to_targetDestination(sourceFileName_targetFileName_dict, source_directory, target_directory);
            ...
            sourceFileName_targetFileName_dict.Clear();
            sourceFileName_targetFileName_dict.Add("Supplemental_table_MBCOL1.txt", "Supplementary Data 23A - drug-selective DEGs EC coculture - MBCOL1.txt");
            sourceFileName_targetFileName_dict.Add("Supplemental_table_MBCOL2.txt", "Supplementary Data 23B - drug-selective DEGs EC coculture - MBCOL2.txt");
            sourceFileName_targetFileName_dict.Add("Supplemental_table_MBCOL3.txt", "Supplementary Data 23C - drug-selective DEGs EC coculture - MBCOL3.txt");
            sourceFileName_targetFileName_dict.Add("Supplemental_table_MBCOL4.txt", "Supplementary Data 23D - drug-selective DEGs EC coculture - MBCOL4.txt");
            Copy_sourceFiles_to_targetDestination(sourceFileName_targetFileName_dict, source_directory, target_directory);
            ...
            sourceFileName_targetFileName_dict.Clear();
            sourceFileName_targetFileName_dict.Add("Supplemental_table_MBCOL1.txt", "Supplementary Data 24A - complete DEGs EC coculture - MBCOL1.txt");
            sourceFileName_targetFileName_dict.Add("Supplemental_table_MBCOL2.txt", "Supplementary Data 24B - complete DEGs EC coculture - MBCOL2.txt");
            sourceFileName_targetFileName_dict.Add("Supplemental_table_MBCOL3.txt", "Supplementary Data 24C - complete DEGs EC coculture - MBCOL3.txt");
            sourceFileName_targetFileName_dict.Add("Supplemental_table_MBCOL4.txt", "Supplementary Data 24D - complete DEGs EC coculture - MBCOL4.txt");
            Copy_sourceFiles_to_targetDestination(sourceFileName_targetFileName_dict, source_directory, target_directory);
            ...
            sourceFileName_targetFileName_dict.Clear();
            sourceFileName_targetFileName_dict.Add("Supplemental_table_MBCOL1.txt", "Supplementary Data 25A - DEGs no 1st EA EC coculture - MBCOL1.txt");
            sourceFileName_targetFileName_dict.Add("Supplemental_table_MBCOL2.txt", "Supplementary Data 25B - DEGs no 1st EA EC coculture - MBCOL2.txt");
            sourceFileName_targetFileName_dict.Add("Supplemental_table_MBCOL3.txt", "Supplementary Data 25C - DEGs no 1st EA EC coculture - MBCOL3.txt");
            sourceFileName_targetFileName_dict.Add("Supplemental_table_MBCOL4.txt", "Supplementary Data 25D - DEGs no 1st EA EC coculture - MBCOL4.txt");
            Copy_sourceFiles_to_targetDestination(sourceFileName_targetFileName_dict, source_directory, target_directory);

            source_directory = Global_directory_class.Results_directory + Global_directory_class.Drug_pk_pd_subdirectory;
            sourceFileName_targetFileName_dict.Clear();
            sourceFileName_targetFileName_dict.Add("Genomic_variants_Only_drug_related_mechanisms_outlier_supplTable.txt", "Supplementary Data 26 - Genomic variants PK PD.txt");
            Copy_sourceFiles_to_targetDestination(sourceFileName_targetFileName_dict, source_directory, target_directory);
            ...
            sourceFileName_targetFileName_dict.Clear();
            sourceFileName_targetFileName_dict.Add("SupplTable_Cardiotoxicity_SCP_variants_foreach_drug_beta0.25_penalty0.5_minAQ0.txt", "Supplementary Data 27 - Genomic variants SCPs.txt");
            Copy_sourceFiles_to_targetDestination(sourceFileName_targetFileName_dict, source_directory, target_directory);
        }
        ...
        public static void Organize_figures_and_supplemental_figures()
        {
            ...
            source_directory = Global_directory_class.Results_svd_enrichment_directory;
            sourceFileName_targetFileName_dict.Clear();
            sourceFileName_targetFileName_dict.Add("DEGenes_iPSCdCMs_ECCoCulture_enrichment_maxP0.05_top600DEGs_MBCOL1.pdf", "Suppl Figure 29A - EC coculture - Top MBCOL1 SCPs.pdf");
            Copy_sourceFiles_to_targetDestination(sourceFileName_targetFileName_dict, source_directory, target_directory);

            source_directory = Global_directory_class.Results_svd_enrichment_directory;
            sourceFileName_targetFileName_dict.Clear();
            sourceFileName_targetFileName_dict.Add("DEGenes_iPSCdCMs_ECCoCulture_enrichment_maxP0.05_top600DEGs_MBCOL2.pdf", "Suppl Figure 29B - EC coculture - Top MBCOL2 SCPs.pdf");
            Copy_sourceFiles_to_targetDestination(sourceFileName_targetFileName_dict, source_directory, target_directory);

            source_directory = Global_directory_class.Results_svd_enrichment_directory;
            sourceFileName_targetFileName_dict.Clear();
            sourceFileName_targetFileName_dict.Add("DEGenes_iPSCdCMs_ECCoCulture_enrichment_maxP0.05_top600DEGs_MBCOL3.pdf", "Suppl Figure 29C - EC coculture - Top MBCOL3 SCPs.pdf");
            Copy_sourceFiles_to_targetDestination(sourceFileName_targetFileName_dict, source_directory, target_directory);

            source_directory = Global_directory_class.Results_svd_enrichment_directory;
            sourceFileName_targetFileName_dict.Clear();
            sourceFileName_targetFileName_dict.Add("DEGenes_iPSCdCMs_ECCoCulture_enrichment_maxP0.05_top600DEGs_MBCOL4.pdf", "Suppl Figure 29D - EC coculture - Top MBCOL4 SCPs.pdf");
            Copy_sourceFiles_to_targetDestination(sourceFileName_targetFileName_dict, source_directory, target_directory);
