...
class RNASeq_analysis
{
    static void Main_lincs()
    {
        ...
        if (run_csharp_parts_dict.ContainsKey(1))
        {
            ...
            string[] datasets = new string[] { "DEGenes_iPSCdCMs_ECCoCulture", "DEGenes_iPSCdCMs_P0" };
        ...
        if (run_csharp_parts_dict.ContainsKey(2))
        {
            ...
            { 
                ...
                Report_class.WriteLine_in_progress_report("SVD part 2 - R: SVD_0 - SVD_15 finished");
            }
            ...
            {
                reportFinishedAndWait.Wait_for_R_to_finish_second_part();
                Report_class.WriteLine_in_progress_report("SVD part 2 - R: SVD_0 - SVD_15 and SVD part 2 II - C# finished");
            }
        ...
        Report_class.WriteLine_in_progress_report("SVD part 2 - R: SVD_A_A, SVD_A_B and SVD_A_C finished");
        #endregion
        ...
        if (run_csharp_parts_dict.ContainsKey(7))
        {
            ...
            Lincs_svd_manuscript_class.Organize_supplData();
