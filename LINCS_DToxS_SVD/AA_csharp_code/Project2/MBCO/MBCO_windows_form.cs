...
namespace MBCO
{
    ...
    class MBCO_windows_form_input_class
    {
        ...
        public void Write_readMe_file(string completeDirectory)
        {
            ...
            writer.WriteLine("select 'Custom 1' (or 'Example 1') default column names and 'Read all files in directory'. Copy paste this directory");
            writer.WriteLine("(that contains the generated input files for the MBCO application) into the text box 'Read all data files in directory'");
            writer.WriteLine("at the bottom of the application. Press the 'Read data' button within the menu panal. Gene expression profiles,");
            writer.WriteLine("predefined parameter selections and background genes will be automatically imported into the application.");
            writer.WriteLine("");
