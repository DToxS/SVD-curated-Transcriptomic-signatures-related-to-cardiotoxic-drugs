...
Col_names = c("EntityClass","Drug_class","Drug","Cell_line","Plate","Gene_symbol","F1_score_weight","Value","Correlation_method","Minimum_fraction_of_max_f1score","EA_correlation_parameter","Reference_valueType","Dataset","Preprocess_data","Decomposition_method","Icasso_permuations_count")
...
Data_for_r_gene_expression = Data_for_r_gene_expression[order(rownames(Data_for_r_gene_expression)),]
