...
{#Begin - Set general directories
   ...
   DEGs_for_MBCO_PathNet_directory = paste(general_directory,"14_DEGs_MBCO_PathNet/",sep='')
   if (!dir.exists(DEGs_for_MBCO_PathNet_directory)) { dir.create(DEGs_for_MBCO_PathNet_directory) }
}#End - Set general directories

{#Begin - Set comments fileName
...
{#Begin - Directory 14 - Set MBCO PathNet input fileNames
   mbco_original_term = original_term
   if (original_term=="no1stSVD") { mbco_original_term = "no1stEA" }
   if (original_term=="full") { mbco_original_term = "complete" }
   completeDEGs_for_MBCO_PathNet_fileName = paste("DEGs_MBCOPathNet_",mbco_original_term,".txt",sep='')
   drugSelectiveDEGs_for_MBCO_PathNet_fileName = "DEGs_MBCOPathNet_drugSelective.txt"
   readMe_for_MBCO_PathNet_fileName = "ReadMe.txt"
   parameterSettings_for_MBCO_PathNet_fileName = "MBCOApp_parameter_settings.txt"
   complete_completeDEGs_for_MBCO_PathNet_fileName = paste(DEGs_for_MBCO_PathNet_directory,completeDEGs_for_MBCO_PathNet_fileName,sep='')
   complete_completeDEGs_for_MBCO_PathNet_bgGenes_fileName = gsub(".txt","_bgGenes.txt",complete_completeDEGs_for_MBCO_PathNet_fileName)
   complete_drugSelectiveDEGs_for_MBCO_PathNet_fileName = paste(DEGs_for_MBCO_PathNet_directory,drugSelectiveDEGs_for_MBCO_PathNet_fileName,sep='')
   complete_drugSelectiveDEGs_for_MBCO_PathNet_bgGenes_fileName = gsub(".txt","_bgGenes.txt",complete_drugSelectiveDEGs_for_MBCO_PathNet_fileName)
   complete_readMe_for_MBCO_PathNet_fileName = paste(DEGs_for_MBCO_PathNet_directory,readMe_for_MBCO_PathNet_fileName,sep='')
   complete_parameterSettings_for_MBCO_PathNet_fileName = paste(DEGs_for_MBCO_PathNet_directory,parameterSettings_for_MBCO_PathNet_fileName,sep='')
}#End - Directory 14 - Set MBCO PathNet input fileNames
